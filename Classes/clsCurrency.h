...
private:
    ...
    static  vector <clsCurrency> _LoadCurrencysDataFromFile()
    {
        ...
        fstream MyFile;
        MyFile.open("DataBase Files/Currencies.txt", ios::in); 
    ...
    static void _SaveCurrencyDataToFile(vector <clsCurrency> vCurrencys)
    {
        ...
        fstream MyFile;
        MyFile.open("DataBase Files/Currencies.txt", ios::out);
...
public:
    ...
    static clsCurrency FindByCountry(string Country)
    {
        ...
        fstream MyFile;
        MyFile.open("DataBase Files/Currencies.txt", ios::in);//read Mode
