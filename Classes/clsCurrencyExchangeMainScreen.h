...
#include "clsUpdateCurrancyRateScreen.h"
...
private:
    ...
    static short ReadCurrenciesMainMenueOptions()
    {
        ...
        short Choice = clsInputValidate::ReadShotNumberBetween(1, 5, "Enter Number between 1 to 5? ");
        return Choice;
    }
    ...
    {
        clsCurrenciesListScreen::ShowCurranciesListScreen();
    }
